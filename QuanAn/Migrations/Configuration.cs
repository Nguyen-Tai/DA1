namespace QuanAn.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<StoreContext>
    {
        ...
        protected override void Seed(StoreContext context)
        {
            ...
            {
                new Category{ ID=1, Name= "Món Ăn Khô" },
                new Category{ ID=2, Name="Món Ăn Nước" },
                new Category{ ID=3, Name="Nước Giải Khát" },
            };
            context.Categories.AddRange(TempCategory);
            List<Food> TempFood = new List<Food>()
            {
                new Food{ ID=1,Name= "Bánh mì thịt nướng",Price=10000,Unit="Cái"},
                new Food{ ID=2,Name= "Bánh xèo",Price=10000,Unit="Dĩa"},
                new Food{ ID=3,Name= "Bánh khọt nước dừa",Price=10000,Unit="Dĩa"},
                new Food{ ID=4,Name= "Chả cá",Price=20000,Unit="Dĩa"},
                new Food{ ID=5,Name= "Chuối nếp nướng",Price=5000,Unit="Cái"},
                new Food{ ID=6,Name= "Gỏi sứa",Price=20000,Unit="Dĩa"},
                new Food{ ID=7,Name= "Bánh cuốn",Price=10000,Unit="Ly"},
                new Food{ ID=8,Name= "Bắp sào",Price=5000,Unit="Hộp"},
                new Food{ ID=9,Name= "Gỏi tôm",Price=25000,Unit="Dĩa"},
                new Food{ ID=10,Name= "Bún riêu",Price=25000,Unit="Bát"},
                new Food{ ID=11,Name= "Súp cua",Price=10000,Unit="Bát"},
                new Food{ ID=12,Name= "Hủ tiếu tôm",Price=22000,Unit="Bát"},
                new Food{ ID=13,Name= "Phở bò",Price=20000,Unit="Bát"},
                new Food{ ID=14,Name= "Bánh canh cua",Price=25000,Unit="Bát"},
                new Food{ ID=15,Name= "Hủ tiếu chay",Price=15000,Unit="Bát"},
                new Food{ ID=16,Name= "Nui hản sản",Price=30000,Unit="Bát"},
                new Food{ ID=17,Name= "Mì hoành thánh",Price=18000,Unit="Bát"},
                new Food{ ID=18,Name= "Cocacola",Price=10000,Unit="Lon"},
                new Food{ ID=19,Name= "Fanta",Price=10000,Unit="Lon"},
                new Food{ ID=20,Name= "Nước tăng lực Sting",Price=10000,Unit="Lon"},
                new Food{ ID=21,Name= "7UP",Price=10000,Unit="Lon"},
                new Food{ ID=22,Name= "Kem",Price=10000,Unit="Ly"},
                new Food{ ID=23,Name= "Nước khoáng",Price=3000,Unit="Chai"},
                new Food{ ID=24,Name= "Bia 333",Price=10000,Unit="Lon"},
                new Food{ ID=25,Name= "Bia Heineken",Price=10000,Unit="Lon"},
                new Food{ ID=26,Name= "Bia Tiger",Price=10000,Unit="Lon"},
            };
